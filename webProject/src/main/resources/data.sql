...
VALUES
(2, '거실 청소 및 정리수납 요청', '거실의 청소와 함께 정리수납 서비스를 요청합니다.', '거실', '경기도 시흥시 능곡중앙로 120', 37.3584, 126.7834, true, 2, NOW(), NOW()),
(3, '안방 청소 및 정리수납 요청', '안방의 청소와 정리수납을 부탁드립니다.', '안방', '인천시 송림로 120', 37.4810, 126.6353, false, 1, NOW(), NOW()),
(4, '주방 청소 및 정리수납 요청', '주방의 청소와 함께 정리수납 서비스를 요청합니다.', '주방', '경기도 부천시 원미로 200', 37.4848, 126.7596, true, 2, NOW(), NOW()),
(5, '욕실 청소 및 정리수납 요청', '욕실의 청소와 정리수납을 부탁드립니다.', '욕실', '인천시 부평구 부평대로 300', 37.4841, 126.7241, false, 1, NOW(), NOW()),
(6, '거실 및 주방 청소 요청', '거실과 주방의 청소를 요청합니다.', '거실, 주방', '경기도 안양시 동안구 시민대로 400', 37.3917, 126.9305, true, 2, NOW(), NOW()),
(7, '침실 청소 및 정리수납 요청', '침실의 청소와 정리수납을 부탁드립니다.', '침실', '인천시 연수구 송도과학로 500', 37.3922, 126.6520, false, 1, NOW(), NOW()),
(8, '거실 및 침실 청소 요청', '거실과 침실의 청소를 요청합니다.', '거실, 침실', '경기도 광명시 오리로 600', 37.4521, 126.8585, true, 2, NOW(), NOW()),
(9, '주방 및 욕실 청소 요청', '주방과 욕실의 청소를 부탁드립니다.', '주방, 욕실', '인천시 서구 가정로 700', 37.4860, 126.6743, false, 1, NOW(), NOW()),
(10, '전체 청소 및 정리수납 요청', '집 전체의 청소와 정리수납을 요청합니다.', '거실, 안방, 주방, 욕실', '경기도 시흥시 정왕동 800', 37.3707, 126.7404, true, 2, NOW(), NOW()),
(11, '거실 및 주방 정리수납 요청', '거실과 주방의 정리수납 서비스를 부탁드립니다.', '거실, 주방', '인천시 남동구 예술로 900', 37.4569, 126.7209, false, 1, NOW(), NOW()),
(2, '안방 및 침실 청소 요청', '안방과 침실의 청소를 요청합니다.', '안방, 침실', '경기도 김포시 김포대로 1000', 37.6302, 126.7354, true, 2, NOW(), NOW()),
(3, '욕실 청소 요청', '욕실의 청소를 부탁드립니다.', '욕실', '인천시 중구 신포로 1100', 37.4829, 126.6170, false, 1, NOW(), NOW()),
(4, '거실 및 욕실 청소 요청', '거실과 욕실의 청소를 요청합니다.', '거실, 욕실', '경기도 오산시 오산로 1200', 37.1465, 127.0786, true, 2, NOW(), NOW()),
(5, '주방 정리수납 요청', '주방의 정리수납 서비스를 부탁드립니다.', '주방', '인천시 동구 만석로 1300', 37.4820, 126.6169, false, 1, NOW(), NOW()),
(6, '침실 정리수납 요청', '침실의 정리수납을 요청합니다.', '침실', '경기도 의정부시 의정부로 1400', 37.7387, 127.0334, true, 2, NOW(), NOW()),
(7, '거실 청소 요청', '거실의 청소를 부탁드립니다.', '거실', '인천시 미추홀구 경인로 1500', 37.4502, 126.6598, false, 1, NOW(), NOW()),
(8, '안방 청소 요청', '안방의 청소를 요청합니다.', '안방', '경기도 양주시 양주로 1600', 37.8011, 127.0520, true, 2, NOW(), NOW()),
(9, '주방 청소 요청', '주방의 청소를 부탁드립니다.', '주방', '인천시 부평구 부평대로 1700', 37.4957, 126.7252, false, 1, NOW(), NOW()),
(10, '욕실 청소 요청', '욕실의 청소를 요청합니다.', '욕실', '경기도 파주시 파주읍 1800', 37.7569, 126.7631, true, 2, NOW(), NOW()),
(11, '전체 청소 요청', '집 전체의 청소를 부탁드립니다.', '거실, 안방, 주방, 욕실', '인천시 계양구 계양대로 1900', 37.5130, 126.7321, false, 1, NOW(), NOW()),
(2, '거실 및 침실 청소 요청', '거실과 침실의 청소를 요청합니다.', '거실, 침실', '경기도 군포시 군포로 2000', 37.3575, 126.9339, true, 2, NOW(), NOW()),
(3, '주방 및 욕실 정리수납 요청', '주방과 욕실의 정리수납 서비스를 부탁드립니다.', '주방, 욕실', '인천시 서구 서곶로 2100', 37.4969, 126.6592, false, 1, NOW(), NOW());
