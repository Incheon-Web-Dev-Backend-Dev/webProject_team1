...
VALUES
(12, 2, 1, '서울시', '거실 및 주방 청소, 창문 청소가 필요합니다. 정리수납 서비스도 원합니다.', '금천구', '청소, 정리수납', '거실 주방 청소 및 정리수납 서비스', NOW(), NOW()),
(13, 3, 0, '서울시', '욕실 청소와 함께 냉장고 정리가 필요합니다. 주방도 깨끗하게 청소해주세요.', '구로구', '청소, 정리수납', '욕실 청소 및 냉장고 정리 서비스', NOW(), NOW()),
(14, 4, 0, '서울시', '전체 청소 및 침실, 거실 청소가 필요하며, 바닥 청소와 먼지 제거를 포함합니다.', '금천구', '청소', '전체 집 청소 및 침실, 거실 청소', NOW(), NOW()),
(15, 5, 1, '서울시', '이사 후 청소와 정리정돈이 필요합니다. 가구 배치도 요청합니다.', '구로구', '이사 청소, 정리수납', '이사 후 청소 및 정리정돈 서비스', NOW(), NOW()),
(12, 7, 1, '서울시', '방 청소와 함께 책상 및 의자 정리정돈을 원합니다.', '구로구', '정리수납', '방 청소 및 정리수납 서비스', NOW(), NOW()),
(13, 8, 1, '서울시', '전체 청소 후 가구 배치를 돕는 서비스가 필요합니다.', '금천구', '청소, 정리수납', '전체 청소 및 가구 배치 서비스', NOW(), NOW()),
(14, 9, 0, '서울시', '집 전체 청소와 함께 욕실 청소가 필요합니다. 바닥 및 창문 청소를 포함해주세요.', '구로구', '청소', '집 전체 청소 및 욕실 청소', NOW(), NOW()),
(15, 10, 0, '서울시', '정리수납 및 방 청소 서비스가 필요합니다. 특히 서랍 정리와 옷 정리가 중요합니다.', '금천구', '정리수납', '방 청소 및 정리수납 서비스', NOW(), NOW());
